  ...
  var render$a = function (_Render) {
    ...
    _createClass(render, [{
      ...
      value: function init() {
        ...
        var handler = this.handler;
        this.uploadOptions = extend(_objectSpread2({}, this.options.upload), handler.rule.props);
